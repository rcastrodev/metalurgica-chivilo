<div class="modal fade" id="modal-create-element-caracteristica">
    <form action="{{ route('company.content.caracteristicasStore') }}" method="post" class="modal-dialog" data-info="reset" enctype="multipart/form-data" data-asyn="no">
        @csrf
